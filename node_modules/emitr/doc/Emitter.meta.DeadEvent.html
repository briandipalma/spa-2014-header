...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeadEvent</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeadEvent</h1>
...
<dt>
    <h4 class="name" id="DeadEvent"><span class="type-signature"></span>new DeadEvent<span class="signature">()</span><span class="type-signature"></span></h4>
