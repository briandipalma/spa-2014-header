...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: MetaEvent</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: MetaEvent</h1>
...
<header>
    ...
    MetaEvent
        ...
        <div class="class-description">A parent class for all meta events.</div>
...
<dt>
    <h4 class="name" id="MetaEvent"><span class="type-signature"></span>new MetaEvent<span class="signature">(event)</span><span class="type-signature"></span></h4>
...
<span class="param-type">*</span>
            ...
            <td class="description last">The event this MetaEvent is about</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="events.js.html">events.js</a>, <a href="events.js.html#line6">line 6</a>
    </li></ul></dd>
