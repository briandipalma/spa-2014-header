...
<header>
    <h2>
        <span class="ancestors"><a href="Emitter.html">Emitter</a>.</span>

    Event
    </h2>

        <div class="class-description">Event provides a convenient base class for events.</div>
...
<dt>
    <h4 class="name" id="Event"><span class="type-signature"></span>new Event<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Event.js.html">Event.js</a>, <a href="Event.js.html#line14">line 14</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="Event.extend"><span class="type-signature">&lt;static> </span>Event.extend<span class="signature">(<span class="optional">properties</span>)</span><span class="type-signature"> &rarr; {function}</span></h4>
...
<span class="param-type">function</span>
            ...
            <td class="description last">an object containing methods to be added to the prototype, or the constructor function, or nothing at all.</td>
        </tr>
...
<div class="param-desc">
    a constructor function for the newly created subclass.
</div>
